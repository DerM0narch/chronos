    ...
    while True:
        ...
        with con:
            ...
            if result == "abwesend" or result == "in Pause":
                ...
                cur.execute("UPDATE Nutzer WHERE kartennr=? SET benutzerStatus = anwesend" , (kartenid,))
                con.commit()
                ...
                cur.execute("UPDATE Nutzer WHERE kartennr=? SET benutzerStatus = abwesend" , (kartenid,))
                con.commit()
        time.sleep(4)
